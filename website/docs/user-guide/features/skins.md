...
| `bunnny` | Barbie-pink coquette theme — sparkles, bows, and bubblegum (inspired by brooklyn.sh) | `Hermes Agent` | Hot pink (`#FF3366`) borders with Barbie-pink (`#FF69B4`) accents and lavender-blush text. Coquette spinner verbs ("sparkling", "twirling", "tying a little bow"). Heart (♡) prompt symbol, sparkle-kaomoji greeting, twin-bunny hero art. Inspired by [brooklyn.sh](https://brooklyn.sh). |
